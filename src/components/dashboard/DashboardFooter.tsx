...
const DashboardFooter: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="block lg:hidden px-4 py-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          ...
          <div className="flex flex-col items-center space-y-2">
            <p 
              className="text-sm"
              style={{ color: theme === 'dark' ? '#e0e0e0' : '#64748b' }}
            >
              Designed and Developed with ❤️ by
            </p>
            <p 
              className="text-sm font-semibold transition-all duration-200 hover:scale-105 cursor-default"
              style={{ 
      ...
      <div className="hidden lg:flex items-center justify-between px-6 lg:px-8 py-4">
